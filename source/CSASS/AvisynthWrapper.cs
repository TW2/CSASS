...
namespace AVS
{
    ...
    public class AvisynthLoader
    {
        public static Bitmap ReadFrameBitmap(AviSynthClip asc, int position)
        {
            Bitmap bmp = null;
            try
            {
    ...
    public class AviSynthClip : IDisposable
    {
        ...
        [DllImport("AvisynthWrapper.dll", ExactSpelling = true, SetLastError = false, CharSet = CharSet.Ansi)]
