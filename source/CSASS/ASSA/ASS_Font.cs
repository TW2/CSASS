...
namespace CSASS
{
    public class ASS_Font
    {
        private Font _font = new Font("Arial", 12f, FontStyle.Regular);

        public ASS_Font(string fontname = "Arial", string fontsize = "12",
