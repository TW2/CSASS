...
namespace CSASS
{
    public class ASS_Style
    {
        ...
        private ASS_Font _font = null;
        private ASS_Color _1 = null;
        private ASS_Color _2 = null;
        private ASS_Color _3 = null;
        private ASS_Color _4 = null;
        ...
        public ASS_Style(string rawline)
        {
            ...
            _font = new ASS_Font(_fontname, _fontsize, _bold, _italic, _underline, _strikeout);
            _1 = ASS_Color.create(_1stColor);
            _2 = ASS_Color.create(_2ndColor);
            _3 = ASS_Color.create(_3rdColor);
            _4 = ASS_Color.create(_4thColor);
        }
        ...
        public ASS_Font Font
        {
            get { return _font; }
            set { _font = value; }
        }

        public ASS_Color PrimaryColour
        {
            get { return _1; }
            set { _1 = value; }
        }

        public ASS_Color KaraokeColour
        {
            get { return _2; }
            set { _2 = value; }
        }

        public ASS_Color OutlineColour
        {
            get { return _3; }
            set { _3 = value; }
        }

        public ASS_Color BackColour
        {
            get { return _4; }
            set { _4 = value; }
        }
